function create(__helpers) {
  var str = __helpers.s,
      ...
      __tag = __helpers.t,
      ____________semantic_tags_semantic_components_form_input_check_boxes_renderer_js = __renderer(require("../../../../semantic-tags/semantic/components/form/input/check-boxes/renderer")),
  ...
  return function render(data, out) {
    ...
    __tag(out,
      ...
      function(out) {
        __tag(out,
          ____________semantic_tags_semantic_components_form_input_check_boxes_renderer_js,
          {
            "list": data.languages,
            "label": "Languages"
          });
