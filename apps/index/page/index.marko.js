function create(__helpers) {
  ...
  return function render(data, out) {
    out.w('<!DOCTYPE html> <html><head><link rel="stylesheet" type="text/css" href="semantic.min.css"><script src="semantic/dist/semantic.min.js">   </script><title>try2 Title</title><lasso-head></lasso-head></head><body><h1>Repo Manager</h1>');
    __tag(out,
